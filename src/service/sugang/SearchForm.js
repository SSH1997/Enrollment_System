            ...
            <div className="Search">
                <div id='classify'>
                    <div id='c1'>
                        <p id='p7'>강의조회 유형</p>
                        <form id='c1_2'>
                            <select id = "qqqq" name="CourseType" onChange={this.handleChange}> 
                                {/* Coursetype */}
                                <option value='관심과목강의조회'>관심 과목 강의 조회&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>
                                <option value='전체강의조회'>전체 강의 조회&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</option>
                            </select>
                        </form>
                        <p id='p3'>이수구분</p>
                        <form id='c1_3'>
